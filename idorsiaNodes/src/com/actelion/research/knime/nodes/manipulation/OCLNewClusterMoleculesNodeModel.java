...
/**
 * <code>NodeModel</code> for the "OCLNewClusterMolecules" node.
 *
...
public class OCLNewClusterMoleculesNodeModel extends NodeModel {
  ...
  protected OCLNewClusterMoleculesNodeModel() {
      super(1, 1);
  }
  ...
  protected DataTableSpec[] configure(DataTableSpec[] inSpecs) throws InvalidSettingsException {
      ...
      List<DataColumnSpec> descriptorColumnSpecs = SpecHelper.getDescriptorColumnSpecs(inputSpec);
      ...
      for (DataColumnSpec moleculeColumnSpec : descriptorColumnSpecs) {
...
//      }
  ...
  protected BufferedDataTable[] execute(BufferedDataTable[] inData, ExecutionContext exec) throws Exception {
      ...
      int descriptorColumnIdx = SpecHelper.getColumnIndex(inputDataTableSpec, m_settings.getInputColumnName());
      ...
      while (iterator.hasNext()) {
          ...
          OCLDescriptorDataCell descriptorDataCell = (OCLDescriptorDataCell) next.getCell(descriptorColumnIdx);
