...
public class OCLSubstructureFilterListNodeModel extends NodeModel {
    private static final int IN_PORT = 0;
    private static final int FILTER_PORT = 1;
    private static NodeLogger LOG = NodeLogger.getLogger(OCLSubstructureFilterListNodeModel.class);
    ...
    public OCLSubstructureFilterListNodeModel() {
        super(2, 2);
    }
...
//        FilterRowTable rejectedTable = new FilterRowTable(inputDataTable, new SubstructureRowFilter(structureColumnIdx, fragments, false));
        ...
        Map<String, Vector<String>> matches = filter(exec, inputDataTable, fragments, structureColumnIdx);
    ...
    private Map<String, Vector<String>> filter(ExecutionContext exec, BufferedDataTable inputDataTable, MoleculeRow[] fragments, int structureColumnIdx) throws CanceledExecutionException {
