...
public class OCLLargestFragmentNodeSettings extends AbstractOCLNodeSettings {
    private static final String DEFAULT_NEW_COLUMN_NAME = "Largest fragment";
    ...
    public OCLLargestFragmentNodeSettings() {
